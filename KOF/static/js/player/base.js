...
export class Player extends AcGameObject {
    constructor(root, info) {
        ...
        this.frame_current_cnt = 0; //当前第几帧
        this.hp = 100;
    ...
    update_move() {
        ...
        this.x += this.vx * this.timedelte / 1000;
        this.y += this.vy * this.timedelte / 1000;
    ...
    render() {
        ...
        if (obj && obj.loaded) {
            if (this.direction > 0) {
                ...
                let k = parseInt(this.frame_current_cnt / obj.frame_rate) % obj.frame_cnt;  //每12帧渲染渲染一张gif图片，循环渲染
